    ...
    public class CommandLink : System.Windows.Forms.Button
    {
        ...
        protected override CreateParams CreateParams
        {
            get
            {
                ...
                cp.Style |= VistaConstants.BS_COMMANDLINK;
                return cp;
            }
        }
        ...
        {
            VistaConstants.SendMessage(this.Handle, VistaConstants.BCM_SETSHIELD, IntPtr.Zero, new IntPtr(showshield_ ? 1 : 0));
        }
        ...
        {
            //Sets the note
            VistaConstants.SendMessage(this.Handle, VistaConstants.BCM_SETNOTE, IntPtr.Zero, NoteText);
        }
