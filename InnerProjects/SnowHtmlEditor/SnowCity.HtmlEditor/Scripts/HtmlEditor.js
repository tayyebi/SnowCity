Type.registerNamespace("SnowCity.HtmlEditor");

SnowCity.HtmlEditor.HtmlEditor = function(element)
{
    SnowCity.HtmlEditor.HtmlEditor.initializeBase(this, [element]);
...
SnowCity.HtmlEditor.HtmlEditor.prototype =
{
    GetVersion: function()
    {
    ...
    OnDialogFrameLoad: function(event)
    {
        ...
        if (f.contentWindow)
        {
            ...
            if (f.contentWindow.Initialize)
            {
                ...
                var behavior = $create(SnowCity.HtmlEditor.DialogBehavior, { "editorControl": this, "dialogDocument": dialogDocument, "contentWindow": f.contentWindow }, null, null, this.get_element());
    ...
    InitializeHTML: function()
    {
        ...
        this.formatHtmlMode = this.isIE && this.get_formatHtmlMode() && !this.standardsMode;
    ...
    IsStandardsMode: function()
    {
        try
        {
            var l = arguments.caller.length; // standards mode issues script error
            return false;
        }
        catch (e)
        {
    ...
    InitializeEditor: function()
    {
        ...
        this.standardsMode = this.IsStandardsMode();
    ...
    initialize: function()
    {
        SnowCity.HtmlEditor.HtmlEditor.callBaseMethod(this, 'initialize');
    ...
    dispose: function()
    {
        ...
        SnowCity.HtmlEditor.HtmlEditor.callBaseMethod(this, 'dispose');
    },
    ...
    GetDesignModeContext: function()
    {
        ...
        try
        {
            ...
            else if (this.designModeDocument.getSelection)
            {
...
SnowCity.HtmlEditor.HtmlEditor.descriptor = 
{
...
SnowCity.HtmlEditor.HtmlEditor.registerClass("SnowCity.HtmlEditor.HtmlEditor", Sys.UI.Control);
