...
SnowCity.HtmlEditor.DialogBehavior = function(element)
{
    SnowCity.HtmlEditor.DialogBehavior.initializeBase(this, [element]);
...
SnowCity.HtmlEditor.DialogBehavior.prototype = 
{
    ...
    initialize: function()
    {
        SnowCity.HtmlEditor.DialogBehavior.callBaseMethod(this, 'initialize');
    ...
    dispose: function()
    {
        SnowCity.HtmlEditor.DialogBehavior.callBaseMethod(this, 'dispose');
    },
...
SnowCity.HtmlEditor.DialogBehavior.descriptor = 
{
...
SnowCity.HtmlEditor.DialogBehavior.registerClass("SnowCity.HtmlEditor.DialogBehavior", Sys.UI.Behavior);
