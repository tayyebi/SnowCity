...
namespace snow.qr.generator.decoder
{
	sealed class FormatInformation
	{
		...
		//UPGRADE_NOTE: Final was removed from the declaration of 'ErrorCorrectionLevelInternal '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
