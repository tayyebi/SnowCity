...
namespace snow.qr.generator.encoder
{
    internal sealed class MatrixUtil
    {
        ...
        internal static void maybeEmbedVersionInfo(int version, ByteMatrix matrix)
        {
            if (version < 7)
            {
        ...
        internal static int calculateBCHCode(int value_Renamed, int poly)
        {
        ...
        internal static void makeVersionInfoBits(int version, BitVector bits)
        {
