...
using WriterException = snow.qr.generator.WriterException;
using EncodeHintType = snow.qr.generator.EncodeHintType;
using ByteArray = snow.qr.generator.common.ByteArray;
using ByteMatrix = snow.qr.generator.common.ByteMatrix;
using CharacterSetECI = snow.qr.generator.common.CharacterSetECI;
using GF256 = snow.qr.generator.common.reedsolomon.GF256;
using ReedSolomonEncoder = snow.qr.generator.common.reedsolomon.ReedSolomonEncoder;
using Mode = snow.qr.generator.decoder.Mode;
using Version = snow.qr.generator.decoder.Version;
namespace snow.qr.generator.encoder
{
	internal sealed class EncoderInternal
	{
		...
		internal static Mode chooseMode(System.String content)
		{
		...
		/// </summary>
		internal static Mode chooseMode(System.String content, System.String encoding)
		{
